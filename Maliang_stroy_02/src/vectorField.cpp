...
void vectorField::draw(){
    ...
    for (int i = 0; i < fieldWidth; i++){
        for (int j = 0; j < fieldHeight; j++){
            ...
            ofLine(px - line.x*length*0.5, py - line.y*length*0.5, px + line.x*length*0.5, py + line.y*length*0.5);
...
//------------------------------------------------------------------------------------
void vectorField::addVectorRect(float x, float y, float vx, float vy, float radius, float strength, int _direction){
    ...
    switch (_direction) {
        case 0:
            for (int i = startx; i < endx; i++){
                for (int j = starty; j < fieldPosY; j++){
                    ...
                    if (distance < fieldRadius){
                        ...
                        float pct = 1.0f - (distance / fieldRadius);
                        float strongness = strength * pct;
                        float frctomid = frcToMid * (1-pct);
                        field[pos].x = vx * strongness;
                        field[pos].y = vy * strongness+frctomid;
                    }
                }
            }
            
            for (int i = startx; i < endx; i++){
                for (int j = fieldPosY+1; j < endy; j++){
            ...
            for (int i = startx; i < endx; i++){
                for (int j = fieldPosY; j < fieldPosY+1; j++){
            ...
            for (int i = startx; i < endx; i++){
                for (int j = fieldPosY+1; j < endy; j++){
                    ...
                    if (distance < fieldRadius){
                        ...
                        float strongness = strength * pct;
                        float frctomid = frcToMid * (1-pct);
                        field[pos].x = vx * strongness+frctomid;
                        field[pos].y = vy * strongness;
                    }
                }
            }
        ...
        case 2:
            for (int i = startx; i < fieldPosX; i++){
                for (int j = starty; j < endy; j++){
            ...
            for (int i = fieldPosX+1; i < endx; i++){
                for (int j = starty; j < endy; j++){
            ...
            for (int i = fieldPosX; i < fieldPosX+1; i++){
                for (int j = fieldPosY; j < endy; j++){

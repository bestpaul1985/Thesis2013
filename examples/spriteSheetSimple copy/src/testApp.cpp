...
void testApp::setup(){
	ofSetFrameRate(0);
	spriteRenderer = new ofxSpriteSheetRenderer(1, 10000, 0, 350);
	spriteRenderer->loadTexture("guyspritetest.png", 1750, GL_NEAREST);
//    spriteRenderer->loadTexture(<#string fileName#>, <#int widthHeight#>, <#int internalGLScaleMode#>)
//    spriteRenderer->loadTexture(<#CollageTexture *_texture#>)
...
void testApp::draw(){
    ...
    float scl = ofMap(mouseY, 0, ofGetHeight(), 0.2, 2);
    ofScale(scl, scl);
	spriteRenderer->draw();

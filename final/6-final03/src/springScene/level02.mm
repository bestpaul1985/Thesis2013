...
void level02::setup(){
    ...
    //Listener
	ofAddListener(world_A.contactStartEvents, this, &level02::contactStart_worldA);
	ofAddListener(world_A.contactEndEvents, this, &level02::contactEnd_worldA);
    ofAddListener(world_B.contactStartEvents,this, &level02::contactStart_worldB);
    ofAddListener(world_B.contactEndEvents,this, &level02::contactEnd_worldB);
    numFootContacts_A = 0;
    numFootContacts_B = 0;
...
//--------------------------------------------------------------
void level02::contactStart_worldA(ofxBox2dContactArgs &e){
...
//--------------------------------------------------------------
void level02::contactEnd_worldA(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
...
//--------------------------------------------------------------
void level02::contactStart_worldB(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
        //a == polygone, b == circle
        ttSetData * aData = (ttSetData*)e.a->GetUserData();
        ttSetData * bData = (ttSetData*)e.b->GetUserData();
...
//--------------------------------------------------------------
void level02::contactEnd_worldB(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
        //a == polygone, b == circle
        ttSetData * aData = (ttSetData*)e.a->GetUserData();
        ttSetData * bData = (ttSetData*)e.b->GetUserData();
...
//-------------------------------------------------------------
void level02::drawScene(int iDraw){
...
//--------------------------------------------------------------
void level02::touchDown(ofTouchEventArgs & touch){
...
//--------------------------------------------------------------
void level02::touchMoved(ofTouchEventArgs & touch){
    control.touchMove(touch.x, touch.y,touch.id);
}

//--------------------------------------------------------------
void level02::touchUp(ofTouchEventArgs & touch){
    control.touchUp(touch.x, touch.y,touch.id);
}

//--------------------------------------------------------------
void level02::touchDoubleTap(ofTouchEventArgs & touch){

}

//--------------------------------------------------------------
void level02::touchCancelled(ofTouchEventArgs & touch){
    
}

//--------------------------------------------------------------
void level02::lostFocus(){

}

//--------------------------------------------------------------
void level02::gotFocus(){

}

//--------------------------------------------------------------
void level02::gotMemoryWarning(){

}

//--------------------------------------------------------------
void level02::deviceOrientationChanged(int newOrientation){

}
//--------------------------------------------------------------
void level02::position(){

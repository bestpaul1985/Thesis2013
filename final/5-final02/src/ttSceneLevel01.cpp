...
#include "ttSceneLevel01.h"
//--------------------------------------------------------------
void ttSceneLevel01::setup(){
...
//--------------------------------------------------------------
void ttSceneLevel01::contactStart_worldA(ofxBox2dContactArgs &e){
...
//--------------------------------------------------------------
void ttSceneLevel01::contactEnd_worldA(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
...
//--------------------------------------------------------------
void ttSceneLevel01::contactStart_worldB(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
        //a == polygone, b == circle
        ttSetData * aData = (ttSetData*)e.a->GetUserData();
        ttSetData * bData = (ttSetData*)e.b->GetUserData();
...
//--------------------------------------------------------------
void ttSceneLevel01::contactEnd_worldB(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
        //a == polygone, b == circle
        ttSetData * aData = (ttSetData*)e.a->GetUserData();
        ttSetData * bData = (ttSetData*)e.b->GetUserData();
...
//-------------------------------------------------------------
void ttSceneLevel01::drawScene(int iDraw){
...
//--------------------------------------------------------------
void ttSceneLevel01::touchDown(ofTouchEventArgs & touch){
...
//--------------------------------------------------------------
void ttSceneLevel01::touchMoved(ofTouchEventArgs & touch){
    control.touchMove(touch.x, touch.y,touch.id);
    
}

//--------------------------------------------------------------
void ttSceneLevel01::touchUp(ofTouchEventArgs & touch){
    control.touchUp(touch.x, touch.y,touch.id);
}
//--------------------------------------------------------------
void ttSceneLevel01::position(){

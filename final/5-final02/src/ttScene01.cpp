...
void ttScence01::setup(){
    ...
    //Listener
	ofAddListener(world_A.contactStartEvents, this, &ttScence01::contactStart_worldA);
	ofAddListener(world_A.contactEndEvents, this, &ttScence01::contactEnd_worldA);
    ofAddListener(world_B.contactStartEvents,this, &ttScence01::contactStart_worldB);
    ofAddListener(world_B.contactEndEvents,this, &ttScence01::contactEnd_worldB);
    numFootContacts_A = 0;
    numFootContacts_B = 0;
...
//--------------------------------------------------------------
void ttScence01::contactStart_worldA(ofxBox2dContactArgs &e){
...
//--------------------------------------------------------------
void ttScence01::contactEnd_worldA(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
...
//--------------------------------------------------------------
void ttScence01::contactStart_worldB(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
        //a == polygone, b == circle
        ttSetData * aData = (ttSetData*)e.a->GetUserData();
        ttSetData * bData = (ttSetData*)e.b->GetUserData();
...
//--------------------------------------------------------------
void ttScence01::contactEnd_worldB(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
        //a == polygone, b == circle
        ttSetData * aData = (ttSetData*)e.a->GetUserData();
        ttSetData * bData = (ttSetData*)e.b->GetUserData();
...
//-------------------------------------------------------------
void ttScence01::drawScene(int iDraw){
...
//--------------------------------------------------------------
void ttScence01::touchDown(ofTouchEventArgs & touch){
...
//--------------------------------------------------------------
void ttScence01::touchMoved(ofTouchEventArgs & touch){
    control.touchMove(touch.x, touch.y,touch.id);
    
}

//--------------------------------------------------------------
void ttScence01::touchUp(ofTouchEventArgs & touch){
    control.touchUp(touch.x, touch.y,touch.id);
}
//--------------------------------------------------------------
void ttScence01::position(){

...
void testApp::setup(){	
    ...
    bFixedButtonP1 = false;
    //********** Guy ******************
    myGuy.setup(character1.getPosition().x,character1.getPosition().y);
    character1.setPhysics(3, 0, 0.5f);
    character1.setup(worldP1.getWorld(), 200, 800, myGuy.width/2, myGuy.height/2);
    character1.body->SetFixedRotation(true);
    myGuy.getCenter = character1.getPosition();
    lastPosP1 = character1.getPosition();
    //********** Girl *******************
    myGirl.setup(character2.getPosition().x, character2.getPosition().y);
    character2.setPhysics(3, 0, 0.5f);
    character2.setup(worldP2.getWorld(), 568, 224, myGirl.width/2, myGirl.height/2);
    character2.body->SetFixedRotation(true);
    myGirl.getCenter = character2.getPosition();
    lastPosP2 = character2.getPosition();
    //********** keys *******************
    key1.setup(0);
...
void testApp::update(){
    ...
    if(bClimb2){
        ...
        character1.addAttractionPoint(posClimb2.x , posClimb2.y+climbUp2, 100);
    ...
    if(bClimb){
        ...
        character2.addAttractionPoint(posClimb.x,posClimb.y+climbUp, 100);
        ...
        character2.setDamping(0.8f);
    }else{
        character2.setDamping(0.98f);
    }
    ...
    //*********** diffP2 *******************
    diffP2 = character2.getPosition()-lastPosP2;
    ...
    if (bFixedButtonP2 == true) {
        ...
        if (character1.getPosition().x > 0&& character1.getPosition().x <min ) {
            
             myGuy.update(myGuy.getCenter.x + diffP1.x ,character1.getPosition().y);
            
        }else if( character1.getPosition().x > (3000-max)&& character1.getPosition().x <3000 ){
            ...
            if(myGuy.getCenter.x > max){
                myGuy.update(max, character1.getPosition().y);
                offSet = character1.getPosition() - myGuy.getCenter;
            }
            
            if(myGuy.getCenter.x < min){
                myGuy.update(min, character1.getPosition().y);
                offSet = character1.getPosition() - myGuy.getCenter;
            }
        }
    }else{
        myGuy.update(384,character1.getPosition().y);
        offSet = character1.getPosition() - myGuy.getCenter;
    }
    ...
    if (bFixedButtonP1 == true) {
        if (character2.getPosition().x < 768 && character2.getPosition().x > max ) {
            
            myGirl.update(myGirl.getCenter.x + diffP2.x, character2.getPosition().y);
            
        }else if( character2.getPosition().x > 768-2400 && character2.getPosition().x < max-2400){
            ...
            if(myGirl.getCenter.x > max){
                myGirl.update(max, character2.getPosition().y);
                offSet2 = character2.getPosition() - myGirl.getCenter;
            }
            
            if(myGirl.getCenter.x < min){
                myGirl.update(min, character2.getPosition().y);
                offSet2 = character2.getPosition() - myGirl.getCenter;
        ...
        myGirl.update(384,character2.getPosition().y);
        offSet2 = character2.getPosition() - myGirl.getCenter;
    }
    //*********** Accelerometer *******************
...
//    ofxBox2dRect rect1;
    ...
    switch (keyState1) {
        ...
        case 1:{
            ...
            ofPoint temp;
            temp.x = character1.getPosition().x + keyoffset1;
            temp.y = beltPosP1.y+20;
            key1.update(temp);
            keysubstitute1.setPosition(character1.getPosition().x +40, beltPosP1.y);
            if (myGuy.bReverse == false) {
                key1.angle =0;
            }else{
                key1.angle =180;
        ...
        case 2:{
            ...
            ofPoint temp;
            temp.x = character2.getPosition().x - keyoffset1;
            temp.y = beltPosP2.y-20;
            key1.update(temp);
            keysubstitute1.setPosition(character2.getPosition().x -40, beltPosP2.y);
            if (myGirl.bReverse == false) {
                key1.angle =180;
            }else{
                key1.angle =0;
    ...
    switch (keyState2) {
        ...
        case 1:{
            ...
            ofPoint temp;
            temp.x = character1.getPosition().x + keyoffset2;
            temp.y = beltPosP1.y+20;
            key2.update(temp);
            keysubstitute2.setPosition(character1.getPosition().x + 40, beltPosP1.y);
            if (myGuy.bReverse == false) {
                key2.angle =180;
            }else{
                key2.angle =0;
        ...
        case 2:{
            ...
            ofPoint temp;
            temp.x = character2.getPosition().x - keyoffset2;
            temp.y = beltPosP2.y-20;
            key2.update(temp);
            keysubstitute2.setPosition(character2.getPosition().x - 40, beltPosP2.y);
            if (myGirl.bReverse == false) {
                key2.angle =0;
            }else{
                key2.angle =180;
    ...
    if (bRope1 == false&&bRopeIconAnimationDone1==false) {
        ...
        posRope1.resetForce();
        posRope1.addAttractionForce(character1.getPosition().x,character1.getPosition().y , 3000, 0.9);
        posRope1.addForce(0, 0);
        posRope1.addDampingForce();
        posRope1.update();
        rope1.pos = posRope1.pos;
        if ((rope1.pos-character1.getPosition()).length()<10) {
            rope1.bFixed = true;
            rope1.bScale = false;
            bRopeInUse1 = true;
            invP1.num = 4;
    ...
    if (bRope2 == false&&bRopeIconAnimationDone2==false) {
        ...
        posRope2.resetForce();
        posRope2.addAttractionForce(character2.getPosition().x,character2.getPosition().y , 3000, 0.9);
        posRope2.addForce(0, 0);
        posRope2.addDampingForce();
        posRope2.update();
        rope2.pos = posRope2.pos;
        if ((rope2.pos-character2.getPosition()).length()<10) {
            rope2.bFixed = true;
            rope2.bScale = false;
            bRopeInUse2 = true;
            invP2.num = 5;
...
void testApp::touchDown(ofTouchEventArgs & touch){
    ...
    if ( P1F.bPressed && (chestSub1.getPosition()-keysubstitute2.getPosition()).length()<100 && keyState2 == 1 && myChest1.open == false) {
        ...
        if (keyState1 != 1 && keyState2 != 1) {
            ...
            if (length1.length() < length2.length()) {
                ...
                keysubstitute1.setup(worldP1.getWorld(), character1.getPosition().x, character1.getPosition().y, key1.width/2, key1.height/2);
                ...
                keysubstitute2.setup(worldP1.getWorld(), character1.getPosition().x, character1.getPosition().y, key2.width/2, key2.height/2);
                keysubstitute2.body->SetActive(false);
                key2.angle = 180;
                pickUpKeySound.play();
            }
    ...
    if ( P2F.bPressed && (chestSub2.getPosition()-keysubstitute1.getPosition()).length()<100 && keyState1 == 2 && myChest2.open == false) {
        ...
        if (keyState1 != 2 && keyState2 != 2) {
            ...
            if (length3.length() < length4.length()) {
                ...
                keysubstitute1.destroy();
                keysubstitute1.setPhysics(30, 0.1, 0);
                keysubstitute1.setup(worldP2.getWorld(), character2.getPosition().x, character2.getPosition().y, key1.width/2, key1.height/2);
                keysubstitute1.body->SetActive(false);
                key1.angle = 180;
                pickUpKeySound.play();
            }else{
                ...
                keysubstitute2.destroy();
                keysubstitute2.setPhysics(30, 0.1, 0);
                keysubstitute2.setup(worldP2.getWorld(), character2.getPosition().x, character2.getPosition().y, key2.width/2, key2.height/2);
                keysubstitute2.body->SetActive(false);
                key2.angle = 0;
                pickUpKeySound.play();
            }
    ...
    if(P2F.bPressed && (ropeStroke1.getClosestPoint(myGirl.getCenter)- myGirl.getCenter).length() < myGirl.height/2+20 && bRopeInUse1){
        bClimb = true;
        posClimb = character2.getPosition();
        cout<<"1"<<endl;
    }
    ...
    if(P1F.bPressed && (ropeStroke2.getClosestPoint(myGuy.getCenter)- myGuy.getCenter).length() < myGuy.height/2+20 && bRopeInUse2){
        bClimb2 = true;
        posClimb2 = character1.getPosition();
        cout<<"1"<<endl;
    }

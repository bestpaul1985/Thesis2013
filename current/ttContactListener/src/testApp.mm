...
void testApp::setup(){	
	...
	ofAddListener(world_A.contactStartEvents, this, &testApp::contactStart);
	ofAddListener(world_A.contactEndEvents, this, &testApp::contactEnd);
    ofAddListener(world_B.contactStartEvents,this, &testApp::contactStart);
    ofAddListener(world_B.contactEndEvents,this, &testApp::contactStart);
    ...
    ground_A.setData(new ttGroundData);
    ttGroundData* sd = (ttGroundData*) ground_A.getData();
    sd->groundId = 0;
    sd->bHit = false;
    ...
    ground_B.setData(new ttGroundData);
    sd = (ttGroundData*) ground_B.getData();
    sd->groundId = 0;
    sd->bHit = false;
...
void testApp::contactStart(ofxBox2dContactArgs &e){
    ...
    if(e.a != NULL && e.b != NULL) {
        ...
        if(e.a->GetType() == b2Shape::e_polygon && e.b->GetType() == b2Shape::e_circle) {
           ...
           ttGroundData  * aData = (ttGroundData*)e.a->GetBody()->GetUserData();
           ttRopeData  * bData = (ttRopeData*)e.b->GetBody()->GetUserData();
...
void testApp::contactEnd(ofxBox2dContactArgs &e){
    if(e.a != NULL && e.b != NULL) {
        ...
        ttRopeData * aData = (ttRopeData*)e.a->GetBody()->GetUserData();
        ttGroundData * bData = (ttGroundData*)e.b->GetBody()->GetUserData();
